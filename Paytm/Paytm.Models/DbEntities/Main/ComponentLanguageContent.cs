...
namespace Paytm.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(Paytm.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(Paytm.Models.Main.LanguageContent.ComponentLanguageContents))]
